        ...
        <div className="row ">
          ...
          <div className={`col-12 col-sm-8  ${styles.para}`}>
            ...
            <p style={{ textAlign: "justify" }}>
              Video bio Unlike other dating apps, users will be swiping on a
              video bio of their potential date instead of a photo. Nectar users
              will create a video bio which can be as short or long as you want
              (45seconds). Check out some sample bios! Question prompters will
              pop on screen while you film to help you OR you can simply say
              ‘Hey there, it’s Sam here, check out my profile!’
            </p>
          </div>
        </div>
      </div>
      <div className="col-md-9 offset-md-2 col-xs-12">
        <div className="row ">
          <div className="col-12  col-sm-4 d-flex align-items-center justify-content-center">
            {/* <img
